                    ...
                    <span style="width: 70px; height: 70px"
                        ><span class="congratulations-svg"
                            ...
                            >
                                ...
                                ></polyline></svg></span
                    ></span>
                    <h1 class="">Congratulations John</h1>
                    <p class="">
                ...
                <div class="container">
                    <div class="pie-chart-desc">
                        ...
                        <p>
                            ...
                            quod alias, quidem aperiam iusto nisi, incidunt
                            quibusdam quis facilis.
                        </p>
                        <h4>June 80</h4>
                        <button>view months sales</button>
                    </div>
                    <div class="columns pie-chart-circle">
                        <div class="column">
                            <pie-chart
                                style="
                                    height: 300px;
...
.card {
    ...
    border-radius: 10px;
    margin-bottom: 2rem;
    animation: anim1 0.5s cubic-bezier(0.46, 0.21, 0.88, 0.62);
}
.congratulations {
    ...
    .congratulations-content {
        ...
        .congratulations-svg {
            ...
            padding: 22px;
            border-radius: 50%;
            box-shadow: 0px 0px 15px 0px #554fad;
        }
        h1 {
            margin-bottom: 1rem;
            margin-top: 30px;
